...
# Parámetros
# ========================================
file_in = "spacecraft_mars.dat" # Nombre del fichero de datos
file_out = "spacecraft_mars" # Nombre del fichero de salida (sin extensión)

# Límites de los ejes X e Y
x_min = -2.6 #Radio orbital de Marte
x_max = 2.6
y_min = -2.6
y_max = 2.6
...
ax.set_title("Nave Espacial Tierra-Marte", fontsize=14)
