...
# Parámetros
# ========================================
file_in = "solap(pMC).dat" # Nombre del fichero de datos
file_out = "solap(pMC)" # Nombre del fichero de salida (sin extensión)
...
line, = ax.plot(xs, frames_data[0][1], "-", color="orange", label='T=0.0001', linewidth=1)
lines.append(line)
line, = ax.plot(xs, frames_data[0][2], "-", color="cornflowerblue", label='T=0.01', linewidth=1)
lines.append(line)
line, = ax.plot(xs, frames_data[0][3], "-", color="mediumaquamarine", label='T=0.04', linewidth=1)
lines.append(line)
line, = ax.plot(xs, frames_data[0][4], "-", color="orchid", label='T=0.1', linewidth=1)
lines.append(line)
ax.legend()
